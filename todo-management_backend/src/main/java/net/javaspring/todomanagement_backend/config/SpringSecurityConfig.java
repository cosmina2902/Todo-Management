package net.javaspring.todomanagement_backend.config;


import lombok.AllArgsConstructor;
import net.javaspring.todomanagement_backend.security.JwtAuthenticationEntryPoint;
import net.javaspring.todomanagement_backend.service.JwtAuthenticationFilter;
...
//        UserDetails cosmina = User.builder().username("user1")
...
//
//        return new InMemoryUserDetailsManager(cosmina, admin);
//    }
